...
object RealityballRecords {
  ...
  case class FantasyPrediction(id: String, date: String, gameId: String, position: String, bayesianPrediction: Option[Double], productionRate: Option[Double],
